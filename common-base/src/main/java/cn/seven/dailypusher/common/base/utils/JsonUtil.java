...
public class JsonUtil {
    ...
    public static <T> T toObject(String json, Class<T> cla, String exceptionContent) {
        ...
        try {
            ...
            if (StringUtils.hasText(exceptionContent)) {
    ...
    public static <T> T toGenericObject(String json, Type type) {
        return toGenericObject(json, type, null);
    }

    public static <T> T toGenericObject(String json, Type type, String exceptionContent) {
        checkJsonString(json);
    ...
    public static <T> T toObject(String json, TypeReference<T> type, String exceptionContent) {
        checkJsonString(json);
